"""Performance Claims metric for evaluating performance documentation.

This module implements the Performance metric, which evaluates whether a model's
documentation contains evidence of performance benchmarks, evaluation results,
or performance claims. Uses a hybrid approach combining LLM-based analysis with
heuristic detection of evaluation content (tables, numerical results, benchmark
mentions). Scores are classified into discrete buckets (0.0, 0.25, 0.6, 0.9, 1.0).
"""
